...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <form runat="server">
        <div>
            ...
            <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control" style="background-color: #CCCCCC"></asp:DropDownList>
        </div>
        <br />
        <div>
            <strong>
            ...
            <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control" style="background-color: #CCCCCC"></asp:TextBox>
        </div>
        <br />
